...
#define PERIOD 999            // Period of timer in milliseconds (10 or 100 or 1000)
#define START_DELAY 0         // The delay at the start of the timer in seconds
#define TIME_TO_EXECUTE 3600  // The time to execute in seconds (total execution time an hour)
